  ...
  //the code below presents city attribute id for the main city.
  ...
  //Information for searchedCity through jquery
  var searchedCity = localStorage.getItem("searchTerm");
  $(".recentCities").text(searchedCity);

  //displays current weather of the main city
  ...
  //Presents current weather location of the primary city on page render
  ...
  //Presents user with forecast information for 5 days on the main search
  ...
  //this function below presents the 5-day forecast
  ...
  //renders through the cities previously searched. 
